...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
                ...
                <CardContent>
                  <div className="space-y-3 h-[480px] overflow-y-auto pr-2 show-scrollbar">
                    {pongGameHistory.length > 0 ? (
                      ...
                      <p className="font-pixel text-xs text-center py-4">No Pong games found</p>
                    )}
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <div className="space-y-3 h-[480px] overflow-y-auto pr-2 show-scrollbar">
                    {dinoGameHistory.length > 0 ? (
                      ...
                      <p className="font-pixel text-xs text-center py-4">No Dino games found</p>
                    )}
                  </div>
                </CardContent>
              </Card>
      ...
      />
      {console.log("User data for dialog:", user)}
    </div>
  )
}
