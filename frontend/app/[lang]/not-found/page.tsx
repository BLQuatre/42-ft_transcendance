			...
			setPosition((prevPosition) => {
				...
				return {
					x:
						newX <= 0
							? 0
							: newX + textWidth >= containerWidth
								? containerWidth - textWidth
								: newX,
					y:
						newY <= 0
							? 0
							: newY + textHeight >= containerHeight
	...
	return (
		...
		>
			...
			>
				...
				<div className="text-[clamp(1rem,2vw,1.5rem)]">
					{dict.notFound.title}
				</div>
			</div>
			...
			<div className="fixed bottom-8 left-0 right-0 text-center">
				<Link
					href="/"
					className="text-white hover:text-gray-300 underline transition-colors font-pixel"
				>
