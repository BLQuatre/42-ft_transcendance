		...
		<div className="min-h-screen bg-background flex flex-col font-pixel">
			...
			<div className="flex-1 container py-8 px-4 md:px-6 max-w-4xl mx-auto">
				<div className="mb-8 text-center">
					<h1 className="font-pixel text-3xl md:text-4xl mb-4 text-game-blue">
						{dict.terms.title}
					</h1>
				...
				<div className="space-y-8">
					<section className="space-y-4">
						...
						<div className="pl-4 space-y-3">
							{dict.terms.sections.acceptance.content.map(
					...
					<section className="space-y-4">
						...
						<div className="pl-4 space-y-3">
							...
							<ul className="text-sm space-y-2 ml-4">
								{dict.terms.sections.service.items.map(
					...
					<section className="space-y-4">
						...
						<div className="pl-4 space-y-3">
							...
							<ul className="text-sm space-y-2 ml-4">
								{dict.terms.sections.registration.items.map(
									(item: string, index: number) => (
										<li key={index} className="flex items-start gap-2">
											<span className="text-game-blue mt-1">•</span>
											{item}
					...
					<section className="space-y-4">
						...
						<div className="pl-4 space-y-3">
							...
							<ul className="text-sm space-y-2 ml-4">
								{dict.terms.sections.community.items.map(
									(item: string, index: number) => (
										<li key={index} className="flex items-start gap-2">
					...
					<section className="space-y-4">
						...
						<div className="pl-4 space-y-3">
							...
							<ul className="text-sm space-y-2 ml-4">
								{dict.terms.sections.intellectual.items.map(
									(item: string, index: number) => (
										<li key={index} className="flex items-start gap-2">
											<span className="text-red-500 mt-1">×</span>
											{item}
					...
					<section className="space-y-4">
						...
						<div className="pl-4 space-y-3">
							...
							<ul className="text-sm space-y-2 ml-4">
								{dict.terms.sections.privacy.items.map(
									(item: string, index: number) => (
										<li key={index} className="flex items-start gap-2">
											<span className="text-game-blue mt-1">•</span>
											{item}
					...
					<section className="space-y-4">
						...
						<div className="pl-4 space-y-3">
							...
							<ul className="text-sm space-y-2 ml-4">
								{dict.terms.sections.liability.items.map(
									(item: string, index: number) => (
										<li key={index} className="flex items-start gap-2">
					...
					<section className="space-y-4">
						...
						<div className="pl-4 space-y-3">
							<p className="text-sm leading-relaxed">
								{dict.terms.sections.termination.content}
							</p>
							<ul className="text-sm space-y-2 ml-4">
								{dict.terms.sections.termination.items.map(
									(item: string, index: number) => (
										<li key={index} className="flex items-start gap-2">
											<span className="text-game-blue mt-1">•</span>
											{item}
				...
				<div className="mt-12 pt-8 border-t text-center">
					<p className="text-xs text-muted-foreground">{dict.terms.footer}</p>
				</div>
			</div>
