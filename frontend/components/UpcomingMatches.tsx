			...
			{matches.length === 0 ? (
				...
				matches.map((match) => {
					...
					return (
						...
						>
							<div className={`bg-game-blue/10 px-4 py-2 flex justify-between items-center`}>
							...
							<div className="p-4">
								<div className="flex items-center justify-between">
									...
									<div className="px-4">
										<div className={`font-pixel text-lg text-game-blue uppercase`}>VS</div>
									</div>
								...
								{match.isLive && (
									<div className="flex justify-center mt-4">
										<Button className={`font-pixel text-xs uppercase bg-game-blue hover:bg-game-blue/90`} onClick={launchGame}>
											PLAY LOCAL
										</Button>
									</div>
								)}
