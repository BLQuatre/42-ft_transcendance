              ...
              {isLoading ? (
                ...
                gameSession?.results
                  ...
                  .map((result) => {
                    ...
                    const enhancedData = isHuman && result.player.user_id
                      ? playerData[result.player.user_id]
                      : null;

                    const displayName = enhancedData?.username || result.player.username;
                    const avatarUrl = enhancedData?.avatar || result.player.avatar;
