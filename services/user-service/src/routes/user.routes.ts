...
import {badRoute, confirmPassword, delUser, getAllUsers, getOneUser, updatePassword, updateUser, createUser, logWithName, logWithEmail} from '../controllers/user.controllers';
...
export async function userRoutes(app: FastifyInstance) {
	...
	app.post('/user/email', logWithEmail)
